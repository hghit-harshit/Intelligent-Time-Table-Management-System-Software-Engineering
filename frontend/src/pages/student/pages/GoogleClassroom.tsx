  ...
  const getCourseColor = (courseName) => {
    const palette = [
      ...
      },
      {
        ...
        ghost: colors.success.ghost,
        border: colors.success.border,
      },
      {
        main: colors.warning.main,
        ghost: colors.warning.ghost,
        border: colors.warning.border,
      },
      {
        main: colors.info.main,
        ghost: colors.info.ghost,
        border: "rgba(37, 99, 235, 0.20)",
      },
      {
        main: colors.error.main,
        ghost: colors.error.ghost,
  ...
  return (
    <>
      ...
      <SubPageHeader
        ...
        subtitle={
          authenticated
            ? `Connected · ${assignments.length} upcoming assignments`
            : "Connect to view your assignments"
        }
        accentColor="#4285F4"
        actions={
          authenticated ? (
            <>
              <button onClick={handleOpenClassroom} style={btnGhost}>
                Open Classroom
              </button>
              <button
          ...
          <>
            ...
            <div style={{ flex: 1, overflowY: "auto", paddingRight: "8px" }}>
              ...
              <StatsGrid
                stats={[
                  {
                    num: assignments.length.toString(),
                  ...
                  },
                  {
                    num: assignments
                      .filter((a) => {
                        ...
                        if (!d) return false;
                        return (
                          new Date(d.year, d.month - 1, d.day) < new Date()
                        );
                      })
                      .length.toString(),
                    label: "Overdue",
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            >
                              ...
                              {assignment.workType && (
                                <span
                                  style={{
                                    background: courseColor.ghost,
                                    color: courseColor.main,
                                    fontSize: "9px",
                                    fontWeight: 600,
                                    padding: "2px 6px",
                                    borderRadius: "3px",
                              ...
                              <span
                                style={{
                                  ...
                                  color: dueInfo.isOverdue
                                    ? colors.error.main
                                    : colors.text.muted,
                                  fontWeight: dueInfo.isOverdue ? 500 : 400,
                                }}
                              >
            ...
            >
              ...
              <div style={{ ...card, padding: "12px" }}>
                ...
                >
                  {[...new Set(assignments.map((a) => a.courseName))].map(
                    (course, i) => {
                      const courseColor = getCourseColor(course);
                      const count = assignments.filter(
                        (a) => a.courseName === course,
                      ).length;
                      return (
                        <div
                          key={i}
                  ...
                  {[
                    ...
                    <button
                      ...
                      style={{
                        ...
                        padding: "8px 10px",
                        color:
                          i === 2 ? colors.error.main : colors.text.secondary,
                        fontSize: fonts.size.sm,
                        cursor: "pointer",
                        display: "flex",
                        alignItems: "center",
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.background =
                          i === 2 ? colors.error.ghost : colors.primary.ghost;
                        e.currentTarget.style.color =
                          i === 2 ? colors.error.main : colors.primary.main;
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.background = colors.bg.raised;
                        e.currentTarget.style.color =
              ...
              <div style={{ ...card, padding: "12px", flex: 1 }}>
                ...
                >
                  <p style={{ margin: "0 0 4px" }}>
                    Assignments are synced from your Google Classroom account.
                  </p>
                  <p style={{ margin: "0 0 4px" }}>
                    Only future assignments with due dates are shown.
                  </p>
                  <p style={{ margin: 0 }}>
